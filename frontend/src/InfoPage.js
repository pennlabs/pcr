          ...
          <div id='courseBox'>
            {this.state.courses.map((a, i) => (
              <Popover
                ...
                button={(
                  <div
                    ...
                    className={`courseInBox${this.state.excludedCourses.indexOf(a.course) !== -1 ? ' courseInBoxGrayed' : ''}`}
                  >
                    {a.course}
              ...
              >
                ...
                {a.instructor}
                <br />
                {Object.values(a.info).sort((x, y) => x.category.localeCompare(y.category)).map((b, i) => (
                  <div key={i}>
                    {getColumnName(b.category)}
                    {' '}
                    <span className='float-right ml-3'>{this.state.isAverage ? b.average : b.recent}</span>
                  </div>
                ))}
              </Popover>
            ))}
      ...
      content = (
        <div className='center-narrow'>
          ...
          <p>
            ...
            <a href='https://docs.google.com/spreadsheet/viewform?hl=en_US&formkey=dGZOZkJDaVkxdmc5QURUejAteFdBZGc6MQ#gid=0'>Request API access</a>
            .
          </p>
          <p>
          ...
          <p>
            ...
            <a href='https://pennlabs.org/mobile/'>PennMobile</a>
            {' '}
            is available for download! In the courses section, you are able to view course descriptions and ratings!
          </p>
