...
export class InfoPage extends Component {
  ...
  render() {
    let content = <ErrorBox>404 Page Not Found</ErrorBox>
      ...
      content = (
        <center className="box" style={{ margin: '30px auto', maxWidth: 720 }}>
          ...
          <p className="courseCartDesc">
            ...
            for your selected courses at once with at-a-glance statistics.
            Search for courses to add them to your cart.
          </p>
          <div id="bannerScore">
    ...
    if (this.props.match.params.page === 'about') {
      content = (
        <div className="center-narrow">
          ...
          <p>
            The student-run Penn Course Review has served as a valuable guide
            for course selection since the 1960s. In 2014, Penn Course Review
            was completely redesigned to simplify the search experience. In
            2018, we hope to continue providing you with the best insights on
            courses and have therefore updated this experience.
          </p>
          <p>
          ...
          <p>
            ...
            ratings for undergraduate courses and professors at the University
            of Pennsylvania. PCR has a long history of being a valuable and
          ...
          <p>
            ...
            evaluations conducted at the end of each semester by the Provost's
            office in conjunction with ISC.
          </p>
          <p>
            Your evaluations and comments feed the Review, so the more
            information you provide about your courses and professors, the more
            comprehensive Penn Course Review will be.
          </p>

          <p>
            If you want to look at courses on the go,
            <a href="https://pennlabs.org/mobile/">PennMobile</a> is available
            for download! In the courses section, you are able to view course
            descriptions and ratings!
          </p>
          <p>
            Version 2.0 was built by Eric Wang, Cassandra Li, Rohan Menezes,
            Vinai Rachakonda, Brandon Lin, Yonah Mann, Josh Doman, Jerry Lu,
            Daniel Tao and designed by Tiffany Chang.
          </p>
      ...
      content = (
        <div id="faqs" className="center-narrow">
          ...
          <div>
            ...
            <p className="answer">
              Each professor, course, and department has its own page. Summary
              ratings for the recent semester and for all semesters are provided
              at the left of each page, with more detailed rating information
              provided on the right. You can choose to view or hide each course
              rating criteria by clicking the plus icon on the top of the table.
              You can also toggle the view mode of ratings between aggregate and
              most recent on the right side of the page. You can hover over the
              tags on the left side of the page or the stars on the right side
              of the page in order to learn more about courses offered in the
              upcoming semester.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="answer">
              ...
              intuitive and accessible. The new search function allows students
              to search by course name, number, or professor. In addition to the
              ...
              reviewed. Students can choose which information is relevant to
              them by selecting which rating criteria appear on the page.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="answer">
              At the end of each semester, the Provost's office, in conjunction
              with ISC, administers Penn's course evaluation form, which
              consists of eleven questions aimed at assessing the quality of the
              course and instructor. Each evaluation question is answered on a
              scale of Poor to Excellent. The ratings are translated numerically
              so that a rating of 0.00 corresponds a student evaluation of
              "Poor," 1.00 corresponds to an evaluation of "Fair," 2.00 to
              "Good," 3.00 to "Very Good," and 4.00 to "Excellent."
            </p>
          </div>
