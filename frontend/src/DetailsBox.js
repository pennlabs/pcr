          ...
          this.setState(state => ({
            ...
            columns: [
              ...
              },
              {
                ...
                show: true,
                required: true,
                Cell: (props) => (typeof props.value === 'undefined' ? <center className='empty'>N/A</center> : (
                  <center>
                    {props.value}
                    {' '}/{' '}
                    {props.original.forms_produced}
                    {' '}
                    <small style={{ color: '#aaa', fontSize: '0.8em' }}>
                    (
                      {(props.value / props.original.forms_produced * 100).toFixed(1)}
                    %)
                    </small>
                  </center>
                )),
            ...
            <div id='select-row'>
              <div>
                ...
                {type === 'course' ? (
                  ...
                  <object type='image/svg+xml' id='select-course-icon' data='/static/image/books-and-bag.svg'>
                ...
                <div id='course-details-data'>
                  <ScoreTable
                    ...
                    data={Object.values(this.state.data.sections).map((i) => ({
                      ...i.ratings, semester: i.semester, name: i.course_name, forms_produced: i.forms_produced, forms_returned: i.forms_returned,
                    }))}
