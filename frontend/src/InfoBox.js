                  ...
                  <div className='course'>
                    <div className='title'>
                      ...
                      <span className='float-right'>
                        ...
                        <a target='_blank' rel='noopener noreferrer' title='Get Alerted' href={`https://penncoursealert.com/?course=${this.props.code}&source=pcr`} className='btn btn-action'><i className='fas fa-fw fa-bell' /></a>
                      </span>
                    ...
                    {!!this.props.data.aliases.length && (
                      <div className='crosslist'>
                        Also:
                        {this.props.data.aliases.map((cls, i) => [i > 0 && ', ', <Link key={i} to={`/course/${cls}`}>{cls}</Link>])}
                      </div>
                    )}
                    ...
                    {this.state.contact &&
                        (
                          <div>
                            <p className='desc'>
                              Email:
                              <a href={`mailto:${this.state.contact.email}`}>{this.state.contact.email.toLowerCase()}</a>
                            </p>
                          </div>
                        )}
                    {this.props.data.notes.map((note, i) => (
