...
def scoretable(context, table):
  '''Create a table.'''
  new_context = {
    'table': table
  }
  return render_to_string('templatetags/tables/scoretable/course.html', new_context)
...
def section_table(context, table, row_id):
  ...
  return render_to_string('templatetags/tables/section_table.html', new_context)
